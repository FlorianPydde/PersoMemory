...
cp "${REPO_DIR}/scripts/lifecycle-check.py" "${HOME}/lifecycle-check.py"
chmod +x "${HOME}/lifecycle-check.py"
echo "Installed lifecycle-check.py to ${HOME}/lifecycle-check.py"
